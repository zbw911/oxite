...
namespace Oxite.Extensions
{
    public static class HtmlHelperExtensions
    {
        ...
        { 
            return OxiteAntiForgeryToken(htmlHelper, htmlHelper.ViewData.GetOxiteViewModel());
        }
        ...
        public static string Gravatar<TModel>(this HtmlHelper<TModel> htmlHelper, string size) where TModel : OxiteViewModel
        {
            ...
            return htmlHelper.Gravatar(
                model.User != null ? (model.User.EmailHash ?? model.User.Email.ComputeHash()).CleanAttribute() : null,
        ...
        public static string Gravatar<TModel>(this HtmlHelper<TModel> htmlHelper, UserAnonymous user, string size) where TModel : OxiteViewModel
        {
            ...
            return htmlHelper.Gravatar(
                ...
                user != null ? user.Name.CleanAttribute() : null,
                size,
                model.Site.GravatarDefault
                );
        }
        ...
        {
            return htmlHelper.Gravatar(
                model.User != null ? model.User.EmailHash.CleanAttribute() : null,
                model.User != null ? model.User.DisplayName.CleanAttribute() : null,
                size,
                model.Site.GravatarDefault
                );
        }

        public static string Gravatar(this HtmlHelper htmlHelper, OxiteViewModel model, Comment comment, string size)
        {
            return htmlHelper.Gravatar(
        ...
        {
            return SimplePager(htmlHelper, pageOfAList, "PageOfPostsByBlog", values, previousText, nextText, alwaysShowPreviousAndNext);
        }
        ...
        public static string Published<TModel>(this HtmlHelper<TModel> htmlHelper) where TModel : OxiteViewModelItemItems<Post, Comment>
        {
