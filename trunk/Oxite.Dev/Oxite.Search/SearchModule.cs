...
namespace Oxite.Modules.Search
{
    public class SearchModule : IOxiteModule
    {
        ...
        public void RegisterFilters(IFilterRegistry filterRegistry)
        {
            ...
            listActionsCriteria.AddMethod<SearchController>(p => p.List(null, 0, null, null));
        ...
        {
            container
                .RegisterType<ISearchPostService, SearchPostService>();
            ...
            container
                ...
                .RegisterType<ISearchPostRepository, SqlServerSearchPostRepository>();
        }
