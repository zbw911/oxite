<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="../Shared/Site.master" Inherits="System.Web.Mvc.ViewPage<OxiteViewModelItemItems<Post, Comment>>" %>
...
<div class="post">
    ...
    <div class="content"><%=Model.Item.Body %></div><%
        if (!(Model.CommentingDisabled && Model.Item.CommentCount < 1))
        {
