...
namespace Oxite.Modules.Membership.Repositories.SqlServer
{
    public class SqlServerUserRepository : IUserRepository
    {
        ...
        private UserAuthenticated projectUser(Guid siteID, oxite_User user)
        {
            ...
            return new UserAuthenticated(user.UserID, user.Username, user.DisplayName, user.Email, user.HashedEmail, (EntityState)user.Status, siteRoles.ToList(), blogRoles.ToList(), postRoles.ToList(), pageRoles.ToList());
        }
