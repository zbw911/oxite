...
namespace Oxite.Modules.Blogs.Extensions
{
    ...
    {
        public static Post ProcessDisplayOfPost(this IPluginEngine pluginEngine, ServiceContext context, Func<Post> getPost)
        {
        ...
        public static IEnumerable<Post> ProcessDisplayOfPosts(this IPluginEngine pluginEngine, ServiceContext context, Func<IEnumerable<Post>> getPosts)
        {
        ...
        public static IPageOfItems<Post> ProcessDisplayOfPosts(this IPluginEngine pluginEngine, ServiceContext context, Func<IPageOfItems<Post>> getPosts)
        {
